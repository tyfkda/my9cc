...
int main() {
  ...
  { long x; ASSERT((long)-1, (x=-1, x)); }

  { char x[3]; x[0]=0; x[1]=1; x[2]=2; char *y=x+1; ASSERT(1, (y[0])); }
  { char x[3]; x[0]=0; x[1]=1; x[2]=2; char *y=x+1; ASSERT(0, (y[-1])); }
  { struct t {char a;} x, y; ASSERT(5, (x.a=5, y=x, y.a)); }
